                                ...
                                <div class="row frame2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="col-12 col-md d-flex align-items-center justify-content-center">
                                                    <img src="{{ url('Asset/Image/style1.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 smallframe" style="background-color: #aa7200;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="col-12 col-md d-flex align-items-center justify-content-center">
                                                    <img src="{{ url('Asset/Image/style2.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row frame2">
                                    <div class="col-sm-6 smallframe" style="background-color: #aa7200;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="col-12 col-md d-flex align-items-center justify-content-center">
                                                    <img src="{{ url('Asset/Image/style3.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 smallframe" style="background-color: #aa7200;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="col-12 col-md d-flex align-items-center justify-content-center">
                                                    <img src="{{ url('Asset/Image/style4.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
